...
public class AlertProcessor 
{
	...
	{
		try {
		this.SocialDataSource = registerServlet.context+"results/"+userDS+"_before.png"; 
		...
		if(srcQuery.contains("ds"))
		{
			...
			for(int i = 0; i < registerServlet.sources.size(); ++i)
			{
				if(((DataSource)(registerServlet.sources.get(i))).srcID.equals(userDS.substring(2)))
				{
					...
					this.probEmagePath =  registerServlet.context+"results/"+srcQuery+"_before.png";
				}
			}
		}
		...
		if(srcQuery.contains("Q"))
		{
			if(registerServlet.queryProcesses.containsKey(srcQuery)){
				...
				this.probEmagePath =  registerServlet.context+"results//"+((QueryProcess)registerServlet.queryProcesses.get(srcQuery)).outputName+"_before.png";
		...
		if(nearestDS.contains("ds"))
		{
			...
			for(int i = 0; i < registerServlet.sources.size(); ++i)
			{
				...
				{
					this.params = ((DataSource)registerServlet.sources.get(i)).finalParam;
					this.solEmagePath =  registerServlet.context+"results/"+nearestDS+"_before.png";
				}
			}
		}
		...
		if(nearestDS.contains("Q"))
		{
			...
			if(registerServlet.queryProcesses.containsKey(nearestDS)){
				...
				this.solEmagePath =  registerServlet.context+"results//"+((QueryProcess)registerServlet.queryProcesses.get(nearestDS)).outputName+"_before.png";
