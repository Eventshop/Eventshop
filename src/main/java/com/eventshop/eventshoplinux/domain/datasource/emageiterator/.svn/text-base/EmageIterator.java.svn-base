...
public class EmageIterator implements Iterator<Emage>, Runnable {
	...
	public void runFromWrapper() 
	{
		...
		while(isRunning)
		{
			...
			{		
				...
				//log.info("set value from point to emage " + col + ", " + row + ", " + point.value);
				total += point.value;
			}
	...
	public static void main(String[] args)
	{
		...
		FrameParameters fp = new FrameParameters(timeWindow, 1000, latUnit,longUnit, swLat, swLong, neLat, neLong);
