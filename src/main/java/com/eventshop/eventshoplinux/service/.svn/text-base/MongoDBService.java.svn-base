...
public class MongoDBService {
	...
	public List<DBObject> findInTimeRange(
			@PathParam(value = "db") String dbName,
			@PathParam(value = "col") String colName,
			@PathParam(value = "startTime") String startTime,	// e.g., 2013-08-05
...
//		
//		System.out.println("startDate: " + startDate + ", " + dbName + ", " + colName);
//		return null;
//	}
//	
//	
	...
	public List<DBObject> find(
			...
			@FormParam("edate") String endDate,
			@FormParam("lat") Double lat,
			@FormParam("lng") Double lng,
			@FormParam("r") Double mile,
		...
		String qstr = "{$and:[{date:{$gt:'"+startDate+"',$lt:'"+endDate+"'}},{'loc':{$geoWithin:{$centerSphere:[["+lng+","+lat+"],"+radious+"]}}}]}";
