...
//				log.info("create ds image (png) for visulization");
	...
	public static void main(String[] args) {
		...
		DataProcess process = new DataProcess(null, EIter, wrapper, tempDir + "ds99_Twitter-test", imgBasePath + "ds99", "ds99");
		...
		DataProcess process2 = new DataProcess(null, EIter2, simWrapper, tempDir + "ds98_Sim", imgBasePath + "ds98", "ds98");
