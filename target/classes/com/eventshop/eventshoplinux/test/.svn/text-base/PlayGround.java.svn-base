...
//sanjukta import com.mongodb.BasicDBObject;
...
//			System.out.println(Config.getProperty("mongoHost") + ":" + Config.getProperty("mongoDB"));
//		MongoClient mongo = new MongoClient(Config.getProperty("mongoHost"));
...
//	
		...
		for(int k = 0; k < dataList.length; k++){
			double p = getMajority((ArrayList<Double>) dataList[k]);
